...
#
# T-PORT-CAIMAN (DEC-PORT-GEN8910-001): caiman is the Pixel 9 Pro, the same
# zumapro / caimito variant as tokay/komodo (GT_VARIANT=zumapro_caimito).
GUARDTALK_RADIO_EXCISED := true

# T-PORT-CAIMAN: pin the excision device identity as per-device data.
...
# Upstream caiman.mk sets PRODUCT_MODEL := Pixel 9 Pro.
