# Late board pass — include at end of vendor/google_devices/husky/BoardConfig.mk
...
# husky ever loses its variant entry. GT_VARIANT=zuma_shusky (shusky-kernels
# 6.1 — the same kernel family as shiba; NOT the akita baseline).
...
# The resolver reads the registry, so husky gets its own variant file
...
# (device/akita/vendor_dlkm.modules.blocklist — bcmdhd4383): handing husky the
