# GuardTalkOS face persona camera extension (DEC-GT-004) — rango
# Face filter OFF by default (GUARDTALK_FACE_FILTER empty). Do not strip
# foldable camera feature XML (com.google.pixel.camera.concurrent_foldable_dual_front).
