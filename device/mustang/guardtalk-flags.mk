...
#
# T-PORT-BATCH-B (DEC-PORT-GEN8910-002): mustang is the Pixel 10 Pro XL, the
# same laguna / muzel variant as frankel/blazer (GT_VARIANT=laguna_muzel,
...
# Upstream mustang.mk sets PRODUCT_MODEL := Pixel 10 Pro XL.
GUARDTALK_PRODUCT_MODEL := GuardTalk Pixel 10 Pro XL
