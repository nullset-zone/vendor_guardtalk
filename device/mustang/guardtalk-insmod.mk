# GuardTalkOS mustang — ensure init.insmod.mustang.cfg is installed on vendor_dlkm.
#
...
LOCAL_PATH_GT_MUSTANG_INSMOD := device/google/laguna-kernels/6.6/grapheneos/muzel

ifeq ($(wildcard $(LOCAL_PATH_GT_MUSTANG_INSMOD)/init.insmod.mustang.cfg),)
$(error GuardTalk mustang: missing $(LOCAL_PATH_GT_MUSTANG_INSMOD)/init.insmod.mustang.cfg)
endif

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH_GT_MUSTANG_INSMOD)/init.insmod.mustang.cfg:$(TARGET_COPY_OUT_VENDOR_DLKM)/etc/init.insmod.mustang.cfg
