...
/**
 * Non-throwing stub for night image capture use case.
 *
 * <p>See {@link BeautyImageCaptureExtenderImpl} for the rationale. GuardTalk implements the night
 * extension via the advanced extender path
 * ({@link androidx.camera.extensions.impl.advanced.NightAdvancedExtenderImpl}).
 *
 * @since 1.0
 */
