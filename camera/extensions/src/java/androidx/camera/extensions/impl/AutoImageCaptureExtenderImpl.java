...
/**
 * Non-throwing stub for auto image capture use case.
 *
 * <p>See {@link BeautyImageCaptureExtenderImpl} for the rationale. GuardTalk implements the auto
 * extension via the advanced extender path
 * ({@link androidx.camera.extensions.impl.advanced.AutoAdvancedExtenderImpl}).
 *
 * @since 1.0
 */
